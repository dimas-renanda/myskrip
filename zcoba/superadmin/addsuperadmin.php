...
require_once 'condb/connect.php';
	function regist($username,$name,$password,$confirm_password)
	{
		...
		$sql = "INSERT INTO superadmin (username,name,salt,password,created_at) VALUES ('$param_username','$param_name','$param_salt','$param_password','$param_created')"; 
				try{
